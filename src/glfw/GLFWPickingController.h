#ifndef GLTK_GLFWPICKINGCONTROLLER_H
#define GLTK_GLFWPICKINGCONTROLLER_H
...
public:
    void setCallback(void (*callback)(std::weak_ptr<const VisualModel>, glm::vec4));
...
private:
    ...
    void (*m_callback)(std::weak_ptr<const VisualModel>, glm::vec4);
